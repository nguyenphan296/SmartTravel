...
import com.example.pkun9.smarttravel.Fragment.FragmentTaxi;
...
public class ActivityAllService extends AppCompatActivity {
    ...
    private void initEvent() {
        ...
        txt_taxi.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment fragment = new FragmentTaxi();
                add_fragment( fragment );
                txt_taxi.setBackgroundResource( R.color.blue );
            }
        } );
    }
    ...
    private void init() {
        ...
        txt_taxi = findViewById( R.id.txt_taxi );
    }
}
